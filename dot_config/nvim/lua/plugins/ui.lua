-- UI Enhancements - LazyVim-inspired with PHP/Symfony focus
      ...
      return {
        ...
        sections = {
          ...
          lualine_c = {
            ...
            -- Symfony project indicator
            {
              function()
                if util.project.is_symfony() then
                  return "🎼 Symfony"
                elseif util.project.is_laravel() then
                  return "🔥 Laravel"
                elseif util.project.is_node() then
                  return "📦 Node.js"
                end
                return ""
              end,
